...
class BreakdownSceneOperations(HookBaseClass):
    ...
    def update(self, item):
        ...
        :type item: dict
        :returns: The path which was set on the item or ``False`` to indicate that a file model update
                  is not necessary (Alias events will trigger the update).
        :rtype: str
        """
    ...
    def update_reference(self, path, old_path, sg_data):
        """
        Update the Alias reference from the given data.

        :param path: The new file path to set the Alias reference to.
        :type path: str
        :param old_path: The file path the Alias reference is currently set to.
        :type old_path: str
